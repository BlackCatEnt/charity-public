<# ==========================
  PM2 Helper for "Charity"
  Save as: A:\Charity\tools\pm2-helper.ps1
  Usage (from PowerShell):
    # one-time: allow this session to run the script
    Set-ExecutionPolicy -Scope Process Bypass -Force

    # run directly
    .\tools\pm2-helper.ps1 -Action status
    .\tools\pm2-helper.ps1 -Action start
    .\tools\pm2-helper.ps1 -Action restart
    .\tools\pm2-helper.ps1 -Action logs
    .\tools\pm2-helper.ps1 -Action stop
    .\tools\pm2-helper.ps1 -Action delete
    .\tools\pm2-helper.ps1 -Action save

    # or dot-source to get functions in your session:
    . .\tools\pm2-helper.ps1
    Start-Charity; Charity-Status; Charity-Logs
========================== #>
