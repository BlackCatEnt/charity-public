...
import { startKeepAlive } from './modules/token-manager.js';
// Legacy token.js disabled; using env + token-manager instead.
...
const live = createLive(CHARITY_CFG, logger, BROADCASTER);
...
live.start();
startKeepAlive({ logger, intervalMs: 60_000 }); // refresh check every 60s (~90s early refresh)
